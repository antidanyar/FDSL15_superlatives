...
\begin{document}
	...
	Suffix: \begin{tikzpicture}[mytree, inv/.style={overlay, coordinate}, sibling distance=4em, level distance=1em]
					\coordinate(top)
						child {node {QP}}
						child {coordinate
							child {node {C2}}
					...
					;
			\end{tikzpicture}
	Prefix: \begin{tikzpicture}[mytree, inv/.style={overlay, coordinate}, sibling distance=4em, level distance=1em]
					\coordinate(top)
						child {coordinate
							child {node {C2}}
							child {node {C1}}
	...
	\begin{frame}{Two types of \textit{luchsh-}}
		...
		\textit{-sh-} as  \begin{tikzpicture}[mytree, inv/.style={overlay, coordinate}, sibling distance=4em, level distance=1em]
					\coordinate(top)
							child {node {S2}}
							child {coordinate
								child {node {S1}}}
	...
	\begin{frame}{Question for \textit{-sh-}}
		...
		So \textit{-ej-} acts as \begin{tikzpicture}[mytree, inv/.style={overlay, coordinate}, sibling distance=4em, level distance=1em]
					\coordinate(top)
							child {node {C2}}
							child {coordinate
								child {node {C1}}}
	...
	\begin{frame}{Modelling \textit{nai}-superlatives}
		...
		\textit{nai-} L-tree: \begin{tikzpicture}[mytree, inv/.style={overlay, coordinate}, sibling distance=4em, level distance=1em]
					\coordinate(top)
							child {node {S2}}
							child {node {S1}}
					;
